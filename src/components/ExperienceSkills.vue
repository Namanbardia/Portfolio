...
<script setup>
import { CodeBracketIcon, CodeBracketSquareIcon, CubeTransparentIcon, ServerIcon, BriefcaseIcon, ChartBarIcon, Square3Stack3DIcon } from "@heroicons/vue/24/solid";
